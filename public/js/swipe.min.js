function Swipe(e, t) {
    ...
    function c() {
        ...
        while (t--) {
            ...
            i.transitions && (n.style.left = t * -a + "px", v(t, f > t ? -a: f < t ? a: 0, 0))
        }
        i.transitions || (s.style.left = f * -a + "px"),
        ...
        var i = +(new Date),
            u = setInterval(function() {
                    ...
                    if (a > r) {
                        s.style.left = n + "px",
                        y && w(),
                        t.transitionEnd && t.transitionEnd.call(event, f, o[f]),
                            clearInterval(u);
                        return
                    }
    ...
    var y = t.auto || 0,
        ...
        T, N = {
            ...
            move: function(e) {
                ...
                typeof T == "undefined" && (T = !!(T || Math.abs(x.x) < Math.abs(x.y))),
                T || (e.preventDefault(), E(), x.x = x.x / (!f && x.x > 0 || f == o.length - 1 && x.x < 0 ? Math.abs(x.x) / a + 1 : 1), m(f - 1, x.x + u[f - 1], 0), m(f, x.x + u[f], 0), m(f + 1, x.x + u[f + 1], 0))
            },
            end: function(e) {
                var n = +(new Date) - S.time,
                    ...
                    c = x.x < 0;
                T || (r && !i ? (c ? (v(f - 1, -a, 0), v(f, u[f] - a, l), v(f + 1, u[f + 1] - a, l), f += 1) : (v(f + 1, a, 0), v(f, u[f] + a, l), v(f - 1, u[f - 1] + a, l), f += -1), t.callback && t.callback(f, o[f])) : (v(f - 1, -a, l), v(f, 0, l), v(f + 1, a, l))),
                    s.removeEventListener("touchmove", N, !1),
