    ...
    <div class="page-container">
        <form action="" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-7 col-sm-5">
                    <input type="text" class="input-text" value="" datatype="*" placeholder="" name="summary" nullmsg="简介不能为空">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>价格：</label>
                <div class="formControls col-xs-7 col-sm-5">
                    <input type="number" class="input-text" value="0" datatype="*" placeholder="" name="price" nullmsg="价格不能为空">
                </div>
            </div>
            <div class="row cl">
